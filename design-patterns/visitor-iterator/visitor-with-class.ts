...
class VisitAllPages<DataType> {
  ...
  async visit(visitor: (results: DataType[]) => void) {
    ...
    do {
      ...
      console.log('JSON response: ', josnResponse);
      const json: {
        next?: string;
        results: DataType[];
      } = josnResponse;
...
// JSON response:  {
//   count: 1304,
//   next: 'https://pokeapi.co/api/v2/pokemon/?offset=160&limit=20',
//   previous: 'https://pokeapi.co/api/v2/pokemon/?offset=120&limit=20',
//   results: [
...
// JSON response:  {
//   count: 1304,
//   next: 'https://pokeapi.co/api/v2/pokemon/?offset=200&limit=20',
//   previous: 'https://pokeapi.co/api/v2/pokemon/?offset=160&limit=20',
//   results: [
